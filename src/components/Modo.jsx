...
<label class="inline-flex items-center relative">
  ...
  <div
    className="relative w-[90px] h-[40px] bg-white peer-checked:bg-zinc-500 rounded-full
        ...
        after:rounded-full after:top-1/2 after:left-[4px]
        after:-translate-y-1/2
        active:after:w-[36px]
        peer-checked:after:left-[80px] peer-checked:after:translate-x-[-100%]
